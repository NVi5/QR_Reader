...
// User logic   
    ...
    reg [11:0] rgb_out_nxt;
     ...
     if(!s00_axi_aresetn) begin
      ...
      always @* begin
           if(char_pixels[3'b111-pixel] == 1 && blnk_delay == 0 && vcount_delay < ypos + ((TEXT_HEIGHT*16)<<scale) && vcount_delay >= ypos && hcount_delay < xpos + ((TEXT_WIDTH*8)<<scale) && hcount_delay >= xpos) rgb_out_nxt = text_color;
